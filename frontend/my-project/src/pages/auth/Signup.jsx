...
function SignatureDraw() {
  return (
    <svg viewBox="0 0 190 60" width="160" height="52" fill="none">
      <defs>
        <linearGradient id="goldGradSignup" x1="0" y1="0" x2="190" y2="0">
...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    const res=  await axiosInstance.post("/auth/register", {
      ...
      toast.success('Registration successfully please verify first and then login');
      navigate(`/verify`);
  ...
  return (
    <div className="relative flex min-h-screen w-full items-center justify-center overflow-hidden bg-gradient-to-br from-indigo-900 via-violet-900 to-blue-900 px-4 py-10">
      ...
      >
        ...
        <p className="mb-3 text-sm text-white/50">Create your account — your work deserves a signature.</p>
        <SignatureDraw />
        ...
        <form onSubmit={handleSubmit} className="mt-7 space-y-4" noValidate>
          ...
          >
            ...
            {loading ? 'ccreating...' : " Create account"}
